	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	         ...
	         <li class="nav-item cta"><a href="about.html" class="nav-link"><span>Saiba Mais</span></a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
			...
			<div class="col-md-4 ftco-animate">
			  <div class="blog-entry" data-aos-delay="200">
				...
				<div class="text d-flex py-4">
				  <div class="meta mb-3">
					<div><a href="#">fdd</a></div>
					<div><a href="#">Admin</a></div>
					<div><a href="#" class="meta-chat"><span class="icon-chat"></span> 3</a></div>
				  </div>
				  <div class="desc pl-3">
					  <h3 class="heading"><a href="#">{{ $postItems->titulo }}</a></h3>
					</div>
				</div>
			  </div>
			</div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-flex">
              <div class="media-body pl-4">
                <h3 class="heading">Projeto 1</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean ac bibendum mauris.</p>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="#" class="py-2 d-block">Quem somos</a></li>
                <li><a href="#" class="py-2 d-block">Saiba mais</a></li>
